...
//	hSCH_Add_Task(Button_update, 1550, 925, 1);		// 100ms/ticket
//	hSCH_Add_Task(Speech_update, 1600, 925, 1);		// 100ms/ticket
//  hSCH_Add_Task(Alarm_update, 1720, 4625, 1);		// 0.5s/ticket
//	hSCH_Add_Task(Clock_update, 1880, 9250, 1);		// 1s/ticket
